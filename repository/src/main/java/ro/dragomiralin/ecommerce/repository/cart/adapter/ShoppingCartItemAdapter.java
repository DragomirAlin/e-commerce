...
public class ShoppingCartItemAdapter implements ShoppingCartPort {
    ...
    public ShoppingCartItemDO save(ShoppingCartItemDO shoppingCartItemDO) {
        ShoppingCartItem shoppingCartItem = mapper.toShoppingCartItem(shoppingCartItemDO);
        ShoppingCartItem createdShoppingCartItem = shoppingCartRepository.save(shoppingCartItem);
    ...
    public Optional<ShoppingCartItemDO> findByIdAndUser(UserDO userDO, long id) {
        User user = userMapper.toUser(userDO);
    ...
    public void delete(long id) {
        Optional<ShoppingCartItem> cartItem = shoppingCartRepository.findById(id);
    ...
    public PageDO<ShoppingCartItemDO> list(UserDO userDO, int page, int size) {
        ...
        Page<ShoppingCartItem> pageResult = shoppingCartRepository.findAllByUser(user, PageRequest.of(page, size));
